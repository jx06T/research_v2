...
!wget -nc -O GenJyuuGothic-Light.ttf https://github.com/jx06T/audio-on-slides/raw/refs/heads/main/GenJyuuGothic-Light.ttf
!wget -nc -O NotoSansTC-Regular.ttf https://github.com/jx06T/audio-on-slides/raw/refs/heads/main/NotoSansTC-Regular.ttf
...
class Config:
    def __init__(self):
        ...
        self.aug_scale = (0.7, 1.32)   # 增強縮放範圍
        self.aug_translate = (0.32, 0.32) # 增強平移範圍
        ...
        self.batch_size = 32
        self.betas = (0.0, 0.9)
        self.num_epochs = 900    # 示範用，實際可設多一點
...
# dataset = PairedFontDataset("GenJyuuGothic-Light.ttf", "kaiu.ttf", cfg)
dataset = PairedFontDataset("NotoSansTC-Regular.ttf", "kaiu.ttf", cfg)
